...
-- Passwords below are bcrypt hashes (10 salt rounds) of the plaintext
-- passwords shown in README.md's test-account table — NOT plaintext
-- themselves. See routes/auth.js, which hashes on signup and compares with
...
-- so this file doesn't break if teams above are inserted in a different order.
